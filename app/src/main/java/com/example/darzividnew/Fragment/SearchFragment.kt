...
import com.example.darzividnew.Adapter.MenuAdapter
import androidx.recyclerview.widget.LinearLayoutManager
import com.example.darzividnew.Model.MenuItem
import com.example.darzividnew.databinding.FragmentSearchBinding
...
// get database reference
    ...
    private fun filterMenuItems(query: String) {
        val filteredMenuItems = originalMenuItems.filter {
            it.serviceName?.contains(query, ignoreCase = true) == true
        }
